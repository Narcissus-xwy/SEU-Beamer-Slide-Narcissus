...
\begin{block}{设计特点}
  \begin{itemize}
    ...
    \item 顶边文字为 SEU 蓝色（\textcolor{structure.fg}{structure.fg}），与底边统一
    \item 顶边背景浅蓝底色，字号 \texttt{\textbackslash footnotesize}
